...
cells = cell.to_df().T
# corr = pd.read_csv(f"./method/quantnorm/results/quantnorm_usoskin.csv", index_col=0)
corr = pd.read_csv(f"./method/fastqn/corr_usoskin.csv", index_col=0)
...
adata.write(f"./method/scbatch/results/scbatch_usoskin.h5ad")